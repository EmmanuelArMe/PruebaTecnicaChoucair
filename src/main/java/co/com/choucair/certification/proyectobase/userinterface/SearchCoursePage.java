...
public class SearchCoursePage extends PageObject {
    ...
    public static final Target BUTTON_GO = Target.the("Click for search the course")
    ...
    public static final Target NAME_COURSE = Target.the("extract the name the course")
